...
stock_data = si.get_data("AAPL", start_date=start_date, end_date=end_date, interval="1m")
...
m=NeuralProphet(changepoints_range=0.90,seasonality_mode='multiplicative',daily_seasonality=4,ar_reg=0.25,num_hidden_layers=3,d_hidden=64)
